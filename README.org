...
#+FORK_FROM: https://github.com/docker-build/p2p

#+TITLE: Remote Desktop Support with P2P TIGERVNC
#+AUTHOR: Bassy Kuo
#+AUTHOR_EMAIL: bassykuo@gmail.com
#+VERSION_DATE: 27 April 2014
  ...
  *port forwarding* on the router/firewall and this would allow the
  ...
  This project is forked from [[https://github.com/docker-build/p2p][p2p-vnc]] 
  but supports *tigervnc* users to has the P2P connection between 
  the two clients. If you are looking for *x11vnc* version, please go to https://github.com/docker-build/p2p 
  which is provided by dashohoxha.
